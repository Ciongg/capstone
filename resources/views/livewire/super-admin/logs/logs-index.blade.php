...
<div class="mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- Search Bar and IP Masking Toggle -->
    <div class="mb-4 bg-white p-4 rounded-lg shadow-sm">
        <div class="flex flex-col md:flex-row gap-4 items-center">
            ...
            <button 
                ...
                class="px-4 py-2 {{ $maskIp ? 'bg-yellow-500 hover:bg-yellow-600' : 'bg-green-500 hover:bg-green-600' }} text-white rounded-md transition-colors whitespace-nowrap flex items-center gap-2"
            >
                @if($maskIp)

                    ...
                    <div class="space-y-4">
                        ...
                        <div class="mt-6 space-y-3">
                            ...
                            <a 
                                ...
                                target="_blank"
                                class="block w-full py-2 rounded bg-blue-500 hover:bg-blue-600 text-white text-center {{ $survey->trashed() ? 'opacity-50 cursor-not-allowed pointer-events-none' : '' }}"
                                @if($survey->trashed()) tabindex="-1" aria-disabled="true" @endif
                            >
                                Preview Survey
                            </a>
                        </div>

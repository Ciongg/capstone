    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h2 class="text-2xl font-bold mb-4">Support & Report Management</h2>
                ...
                <!-- Tab Navigation -->
                <div x-data="{ tab: 'support' }">
                    <nav class="flex border-b border-gray-200 mb-6 -mb-px">
                        <button 
                            x-on:click="tab = 'support'" 
                            :class="{ 'border-blue-500 text-blue-600': tab === 'support', 'border-transparent text-gray-500 hover:text-gray-700': tab !== 'support' }" 
                        ...
                        <button 
                            ...
                            :class="{ 'border-blue-500 text-blue-600': tab === 'reports', 'border-transparent text-gray-500 hover:text-gray-700': tab !== 'reports' }" 
                            class="w-1/2 py-3 px-1 text-center border-b-2 font-medium text-sm"
                        >
                            Report Management
                        </button>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                <input type="text" 
                                    ...
                                    placeholder="Search by subject or user UUID..." 
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <div class="flex space-x-2 flex-wrap">
                                    ...
                                    <button wire:click="filterByType('survey_lock_appeal')" 
                                        class="px-4 py-2 text-sm rounded {{ $requestTypeFilter === 'survey_lock_appeal' ? 'bg-red-600 text-white' : 'bg-gray-200' }}">
                                        Lock Appeals ({{ $lockAppealCount }})
                                    </button>
                                    <button wire:click="filterByType('report_appeal')" 
                                        ...
                                        Report Appeals ({{ $reportAppealCount }})
                                    </button>
                                    <button wire:click="filterByType('account_issue')" 
                                        ...
                                        Account Issues ({{ $accountIssueCount }})
                                    </button>
                                    <button wire:click="filterByType('survey_question')" 
                                        ...
                                        Survey Questions ({{ $surveyQuestionCount }})
                                    </button>
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                                            ...
                                            <td class="py-3 px-6">
                                                <span class="px-2 py-1 rounded text-xs {{ 
                                                    $request->request_type === 'survey_lock_appeal' ? 'bg-red-200 text-red-800' : 
                    ...
                    <div x-show="tab === 'reports'" x-cloak>
                        @livewire('super-admin.reports.report-index', ['skipHeader' => true])
                    </div>
                </div>
            </div>
        </div>

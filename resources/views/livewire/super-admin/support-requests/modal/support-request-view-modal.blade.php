        ...
        <div class="border-b border-gray-200 mb-4" x-data="{ tab: 'details' }">
            ...
            <div class="pt-4">
                ...
                <div x-show="tab === 'response'" x-cloak class="space-y-6">
                    ...
                    <!-- Admin Response Form - Only show if not locked -->
                    @if($this->isLocked)
                    <div class="border-t border-gray-200 pt-6">
                        <div class="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800">
                            <div class="flex items-center">
                                ...
                                <p><strong>This request is locked.</strong> Support requests that have been marked as "{{ ucfirst($supportRequest->status) }}" cannot be modified to prevent spam and calculation inconsistencies.</p>
                            </div>
                        </div>
                    </div>
                    @else

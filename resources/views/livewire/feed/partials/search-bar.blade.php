{{-- Top Bar - Now a single white container with shadow --}}
<div class="flex flex-row justify-between items-center gap-2 mb-4 sm:mb-6 bg-white shadow-md px-4 py-2 rounded-md">
    {{-- Search Bar with border only, no background --}}
    <div class="relative w-3/5 sm:w-auto sm:max-w-md flex-grow">
        ...
        <input
            ...
            class="w-full pl-10 pr-10 py-2 rounded-full bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none"
        />
    ...
    {{-- User Points Display - just the points and icon, no container --}}

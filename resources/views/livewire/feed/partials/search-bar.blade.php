...
<div class="flex justify-between items-center mb-8">
    {{-- Search Bar with Icons on both sides --}}
    <div class="relative max-w-md flex-grow"> {{-- Changed from max-w-2xl to max-w-3xl and added flex-grow --}}
        {{-- Left search icon --}}
    ...
    <div class="flex flex-row items-center">
        <span class="text-4xl text-[#FFB349] font-bold">{{ auth()->user()->points ?? 0 }}</span>

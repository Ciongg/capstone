...
>
    ...
    <button 
        ...
        x-transition
        class="absolute left-1 sm:left-0 top-1/2 -translate-y-1/2 bg-white bg-opacity-70 rounded-full p-1 shadow-md z-10"
    >
    ...
    <button 
        ...
        x-transition
        class="absolute right-1 sm:right-0 top-1/2 -translate-y-1/2 bg-white bg-opacity-70 rounded-full p-1 shadow-md z-10"
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div 
        id="topic-scroll" 
        class="scrollbar-hide flex overflow-x-auto py-3 px-2 space-x-2 sm:space-x-3"
        @scroll.throttle.50ms="checkArrows()"
    >
        {{-- All Topics option --}}
        <button
            wire:click="clearTopicFilter"
            class="whitespace-nowrap px-3 sm:px-4 py-2 rounded-full border text-sm font-medium flex-shrink-0 transition-colors
        ...
        @foreach($topics as $topic)
            <button
                ...
                class="whitespace-nowrap px-3 sm:px-4 py-2 shadow-md rounded-full border text-sm font-medium flex-shrink-0 transition-colors

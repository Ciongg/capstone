        ...
        <div class="w-full max-w-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6"> {{-- Reduced gap --}}
                ...
                <button 
                    ...
                    class="flex flex-col min-h-[260px] rounded-lg overflow-hidden shadow-xl hover:shadow-lg hover:scale-105 hover:ring-2 hover:ring-offset-2 hover:ring-[#03b8ff] transition-all {{ $surveyType === 'basic' ? 'ring-2 ring-offset-2 ring-[#03b8ff] opacity-75 cursor-not-allowed' : '' }}" {{-- Reduced min-h --}}
                    @if($surveyType === 'basic') disabled @endif
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm"> {{-- Reduced h --}}
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectSurveyType('basic')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectSurveyType('basic')" class="w-12 h-12 text-[#03b8ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> {{-- Reduced icon size --}}
                    ...
                    <div class="bg-gray-100 p-4 text-center flex-grow">
                        ...
                        @if($surveyType === 'basic')
                            <div class="flex justify-center mt-2">
                                <span class="text-xs text-[#03b8ff] font-medium">Selected</span>
                            </div>
                        @endif
                    </div>
                </button>
                ...
                <button 
                    ...
                    wire:loading.attr="disabled"
                    wire:loading.class="opacity-50 cursor-not-allowed"
                    class="flex flex-col min-h-[260px] rounded-lg overflow-hidden shadow-xl hover:shadow-lg hover:scale-105 hover:ring-2 hover:ring-offset-2 hover:ring-[#03b8ff] transition-all {{ $surveyType === 'advanced' ? 'ring-2 ring-offset-2 ring-[#03b8ff] opacity-75 cursor-not-allowed' : '' }}" {{-- Reduced min-h --}}
                    @if($surveyType === 'advanced') disabled @endif
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm"> {{-- Reduced h --}}
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectSurveyType('advanced')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectSurveyType('advanced')" class="w-12 h-12 text-[#03b8ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> {{-- Reduced icon size --}}
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6"> {{-- Reduced gap --}}
                ...
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm"> {{-- Reduced h --}}
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectCreationMethod('scratch')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectCreationMethod('scratch')" class="w-12 h-12 text-[#03b8ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> {{-- Reduced icon size --}}
                ...
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm"> {{-- Reduced h --}}
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectCreationMethod('template')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectCreationMethod('template')" class="w-12 h-12 text-[#03b8ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> {{-- Reduced icon size --}}
            ...
            <div class="flex justify-between items-center mt-6">
                ...
                <button 
                    ...
                    wire:loading.attr="disabled"
                    wire:loading.class="opacity-50 cursor-not-allowed"
                    class="flex items-center text-gray-600 hover:text-[#03b8ff] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    <svg wire:loading.remove wire:target="goBack" class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                    <svg wire:loading wire:target="goBack" class="animate-spin w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <span wire:loading.remove wire:target="goBack">Back</span>
                    <span wire:loading wire:target="goBack">Loading...</span>
                </button>
                ...
                <button 
                    ...
                    wire:loading.attr="disabled"
                    wire:loading.class="opacity-50 cursor-not-allowed"
                    class="px-6 py-2 bg-[#03b8ff] text-white font-medium rounded-lg hover:bg-[#0296d1] disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                    @if(!$creationMethod) disabled @endif
                >
                    <span wire:loading.remove wire:target="proceedToCreateSurvey">Continue</span>
                    <span wire:loading wire:target="proceedToCreateSurvey">Creating...</span>
                    <svg wire:loading wire:target="proceedToCreateSurvey" class="animate-spin ml-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                </button>
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                ...
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm">
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectTemplate('iso25010')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectTemplate('iso25010')" class="w-12 h-12 text-[#03b8ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    <div class="bg-gray-100 p-4 flex items-center justify-center relative">
                        <div class="bg-gray-200 w-full px-4 py-5 rounded-3xl flex items-center justify-center h-28 shadow-sm">
                            <!-- Show loading spinner when loading, original icon when not -->
                            <svg wire:loading wire:target="selectTemplate('academic')" class="animate-spin w-12 h-12 text-[#03b8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="selectTemplate('academic')" class="w-12 h-12 text-[#03b8ff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex justify-between items-center mt-6">
                <button 
                    ...
                    class="flex items-center text-gray-600 hover:text-[#03b8ff] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    <svg wire:loading.remove wire:target="goBackToMethod" class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                    <svg wire:loading wire:target="goBackToMethod" class="animate-spin w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <span wire:loading.remove wire:target="goBackToMethod">Back</span>
                    <span wire:loading wire:target="goBackToMethod">Loading...</span>
                </button>

<div x-data="{ tab: 'info' }" class="space-y-4 p-4">
    ...
    <div x-show="tab === 'info'" x-cloak>
        <form wire:submit.prevent="saveSurveyInformation" class="space-y-4" x-data="{ fileName: '' }">
            ...
            <!-- Points Allocated Badge -->
            <div class="mb-4 flex items-center justify-between">
                <div class="flex items-center">
                    <span class="block font-semibold mr-3">Points Allocated:</span>
                ...
                <button type="button" class="px-4 py-2 bg-[#03b8ff] hover:bg-[#0295d1] text-white font-medium rounded transition duration-200">
                    Allocate Points
                </button>
            </div>

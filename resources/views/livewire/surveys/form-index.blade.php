<div class="max-w-7xl mx-auto py-8" x-data="{ activeTab: 'owned' }">
    ...
    <!-- Owned Surveys Tab -->
    <div x-show="activeTab === 'owned'" x-cloak>
    ...
    <div x-show="activeTab === 'shared'" x-cloak>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
                    ...
                    <div class="p-3 flex flex-col flex-grow">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-100 flex justify-between items-center">
                            ...
                            {{-- Empty space where delete button would be --}}
            ...
            @empty
                ...
                <div class="col-span-full text-center text-gray-500 mt-8">
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded mb-4 max-w-xl mx-auto">
                        <div class="font-semibold text-blue-700 mb-2">No shared surveys found</div>
                        <div class="text-sm text-blue-800">
                            You haven't been added as a collaborator to any surveys yet. When someone adds you as a collaborator using your UUID, their surveys will appear here.
                        </div>
                    </div>
                </div>
            @endforelse

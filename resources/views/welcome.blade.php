...
<main class="container mx-auto py-12 px-4 text-center">
    ...
    <a href="{{ route('register') }}" class="mt-4 inline-block bg-[#03b8ff] hover:bg-[#02a0e0] text-white font-semibold px-6 py-2 rounded">
        Register
    </a>
    ...
    <section class="mt-16 bg-gray-100 py-12 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-700">
            <div>
                <div class="text-5xl text-[#03b8ff] mb-2">👤</div>
                <h3 class="text-lg font-semibold">Login</h3>
                <p class="text-sm mt-2">If you don’t have an account, create one. Use school email for educational access.</p>
                <a href="{{ route('register') }}" class="text-[#03b8ff] text-sm mt-1 inline-block">CREATE ACCOUNT</a>
            </div>
            <div>
                <div class="text-5xl text-[#03b8ff] mb-2">📋</div>
            ...
            <div>
                ...
                <a href="/rewards" class="text-[#03b8ff] text-sm mt-1 inline-block">VIEW REWARDS</a>
            </div>
        </div>
    </section>
</main>
